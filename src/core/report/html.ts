...
export function generateHtmlReport(
  ...
  const allFindings: Finding[] = [...scanResult.critical, ...scanResult.medium, ...scanResult.low];
  ...
  const safeFindingsJson = findingsJson.replace(/</g, '\\u003c').replace(/>/g, '\\u003e');
...
<div class="container">
  ...
  <div class="footer">Generated by ShipGuard v${VERSION}</div>
</div>

<script>
(function(){
  var findings = ${safeFindingsJson};
