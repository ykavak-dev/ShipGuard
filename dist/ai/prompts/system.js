...
exports.RISK_PRIORITIZER_PROMPT = exports.FIX_GENERATOR_PROMPT = exports.SECURITY_ANALYST_PROMPT = void 0;
exports.SECURITY_ANALYST_PROMPT = `You are a senior application security engineer with 10+ years of experience in vulnerability assessment and secure code review.
...
// ═════════════════════════════════════════════════════════════════════════════
exports.FIX_GENERATOR_PROMPT = `You are a security-focused senior developer generating minimal, surgical code fixes.
...
// ═════════════════════════════════════════════════════════════════════════════
exports.RISK_PRIORITIZER_PROMPT = `You are a security team lead prioritizing findings for a development team with limited time before a release.
