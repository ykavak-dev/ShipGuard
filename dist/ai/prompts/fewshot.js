...
exports.getAnalyzeFindingExamples = getAnalyzeFindingExamples;
exports.getGenerateFixExamples = getGenerateFixExamples;
// ═════════════════════════════════════════════════════════════════════════════
// analyze_finding examples
// ═════════════════════════════════════════════════════════════════════════════
function getAnalyzeFindingExamples() {
    return [
...
// ═════════════════════════════════════════════════════════════════════════════
function getGenerateFixExamples() {
    return [
...
//# sourceMappingURL=fewshot.js.map